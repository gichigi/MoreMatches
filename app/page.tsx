...
export default function Home() {
  ...
  return (
    <main className="relative h-screen w-full overflow-hidden bg-background">
      ...
      {/* Nav - logo only */}
      <nav
        className={`fixed left-0 right-0 top-0 z-50 flex items-center px-6 py-6 transition-opacity duration-700 md:px-12 ${
      ...
      >
        <section className="flex min-h-screen w-screen flex-col justify-end px-6 pb-16 pt-24 md:px-12 md:pb-24">
          <div className="max-w-3xl">
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-300 relative h-12">
              ...
              <p
                aria-live="polite"
                className={`absolute inset-0 flex items-center font-sans text-lg text-foreground transition-all duration-700 ease-out ${
                  ctaClicked
      ...
      {/* Footer */}
      <footer
        className={`fixed bottom-0 left-0 right-0 z-50 flex items-center px-6 py-5 transition-opacity duration-700 md:px-12 ${
          isLoaded ? "opacity-100" : "opacity-0"
        }`}
      >
        <a
